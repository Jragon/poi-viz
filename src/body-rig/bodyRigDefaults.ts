...
export const DEFAULT_BODY_TORSO_HEIGHT_RATIO = 0.90625;
export const DEFAULT_BODY_HIP_SPAN_SHOULDER_RATIO = 0.6;
export const DEFAULT_BODY_HEAD_RADIUS_RATIO = 0.28125;
export const DEFAULT_BODY_HEAD_GAP_RATIO = 0.1625;
export const DEFAULT_BODY_NECK_OFFSET_RATIO = 0.1;
