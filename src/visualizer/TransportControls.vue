...
<template>
  <section
    class="grid gap-4 rounded-2xl border border-slate-800 bg-slate-950/70 p-4 md:grid-cols-[auto_minmax(0,1fr)_15rem] md:items-center"
  >
    ...
    <div class="grid w-full gap-1 justify-self-end text-right text-sm text-slate-300">
